        ...
        <div className={Style.NavBar_box_right}>
          ...
          <div className={Style.NavBar_box_right_menu}>
            {menuItems.map((item, index) => (
              <div onClick={() => setActive(index + 1)} key={index + 1} className={`${Style.NavBar_box_right_menu_items} ${active === index + 1 ? Style.active_btn : ""}`}>
          ...
          {open && (
            <div className={Style.mobile_menu}>
              {menuItems.map((item, index) => (
                <div onClick={() => setActive(index + 1)} key={index + 1} className={`${Style.mobile_menu_items} ${active === index + 1 ? Style.active_btn : ""}`}>
